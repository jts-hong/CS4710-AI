...
class model(object):
    ...
    def __init__(self, **kwargs):
        ...
        # Default properties
        self.n = kwargs.get('n', 2) #number of players
        self.alpha = kwargs.get('alpha', 0.15)#product differentiation parameter
        self.beta = kwargs.get('beta', 4e-6)#exploration parameter
        self.delta = kwargs.get('delta', 0.95)#discount factor
        self.c = kwargs.get('c', 1)#marginal cost
        self.a = kwargs.get('a', 2)#value of the products
        self.a0 = kwargs.get('a0', 0)#value of the outside option
        self.mu = kwargs.get('mu', 0.25)#product differentiation parameter
        self.k = kwargs.get('k', 15)#dimension of the grid
        self.tstable = kwargs.get('tstable', 1e5)#periods of game stability
        self.tmax = kwargs.get('tstable', 1e7)#max number of iteration
